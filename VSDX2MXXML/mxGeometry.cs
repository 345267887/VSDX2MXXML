...
namespace VSDX2MXXML
{
	...
	protected mxRectangle alternateBounds;
         ...
         */
        public void setRelative(bool value)
        {
            relative = value;
        }
         ...
         */
        public mxPoint getTerminalPoint(bool isSource)
        {
         ...
         */
        public mxPoint setTerminalPoint(mxPoint point, bool isSource)
        {
            if (isSource)
            {
                sourcePoint = point;
