...
namespace VSDX2MXXML
{
    class Shape:Style
    {
         ...
         */
        protected Dictionary<String, Paragraph> paragraphs = null;

        /**
         * mxGraph cell style map
         */
        protected Dictionary<String, String> styleMap = new Dictionary<String, String>();
        ...
        protected List<XmlElement> geom;

        protected mxVsdxGeometryList geomList = null;
        protected bool geomListProcessed = false;

        protected Dictionary<String, String> imageData;
        ...
        protected static String UNICODE_LINE_SEP = new String(new char[] { (char)226, (char)128, (char)168 });

        public mxPathDebug debug = null;

        public Shape(XmlElement shape, mxVsdxModel model): base(shape, model)
        {
            
            this.width = getScreenNumericalValue(this.cellElements[mxVsdxConstants.WIDTH], 0);
            this.height = getScreenNumericalValue(this.cellElements[mxVsdxConstants.HEIGHT], 0);
        }
        ...
        public void processGeomList(mxVsdxGeometryList parentGeoList)
        {
            if (!geomListProcessed)
            {
                ...
                if (geom != null)
                {
                    foreach (XmlElement geoElem in geom)
                    {
