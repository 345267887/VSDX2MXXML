...
namespace mxGraph.view
{
    ...
    using mxICanvas = canvas.mxICanvas;
    using mxCell = model.mxCell;
    using mxGeometry = model.mxGeometry;
    using mxGraphModel = model.mxGraphModel;
    using Filter = model.mxGraphModel.Filter;
    using mxChildChange = model.mxGraphModel.mxChildChange;
    using mxCollapseChange = model.mxGraphModel.mxCollapseChange;
    using mxGeometryChange = model.mxGraphModel.mxGeometryChange;
    using mxRootChange = model.mxGraphModel.mxRootChange;
    using mxStyleChange = model.mxGraphModel.mxStyleChange;
    using mxTerminalChange = model.mxGraphModel.mxTerminalChange;
    using mxValueChange = model.mxGraphModel.mxValueChange;
    using mxVisibleChange = model.mxGraphModel.mxVisibleChange;
    using mxICell = model.mxICell;
    ...
    using mxResources = util.mxResources;
    ...
    /// </summary>
    public class mxGraph : mxEventSource, INotifyPropertyChanged
    {
        ...
        //private static readonly Logger log = Logger.getLogger(typeof(mxGraph).FullName);
        ...
        static mxGraph()
        {
            try
            {
                mxResources.add("mxGraphresources.graph");
            }
            catch (Exception e)
            {
        ...
        /// is 3.9.12.
        /// </summary>
        public const string VERSION = "3.9.12";
        ...
        /// </summary>
        protected internal bool portsEnabled = true;
        ...
        /// </summary>
        //protected internal static IList<mxImageBundle> imageBundles = new LinkedList<mxImageBundle>();
        ...
        /// Fires repaint events for full repaints.
        /// </summary>
        protected internal mxIEventListener updateOriginHandler = new mxIEventListenerAnonymousInnerClass2();
        ...
        private class mxIEventListenerAnonymousInnerClass2 : mxIEventListener
        {
            ...
            public virtual void invoke(object sender, mxEventObject evt)
            {
                //if (outerInstance.AutoOrigin)
                //{
                //    outerInstance.updateOrigin();
                //}
            }
        }
        ...
        /// </summary>
        protected internal mxIEventListener graphModelChangeHandler = new mxIEventListenerAnonymousInnerClass3();
        ...
        private class mxIEventListenerAnonymousInnerClass3 : mxIEventListener
        {
            public mxIEventListenerAnonymousInnerClass3()
            {
            }
        ...
        /// </summary>
        public virtual void addTopmostVerticesAndEdges(object cell, IList<object> cells)
        {
        ...
        public virtual object[] getSelectionCellsForChanges(IList<mxUndoableEdit.mxUndoableChange> changes)
        {
            ...
            while (it.MoveNext())
            {
                ...
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxChildChange)change).Child, cells);
                }
                else if (change is mxGraphModel.mxTerminalChange)
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxTerminalChange)change).Cell, cells);
                }
                else if (change is mxGraphModel.mxValueChange)
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxValueChange)change).Cell, cells);
                }
                else if (change is mxGraphModel.mxStyleChange)
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxStyleChange)change).Cell, cells);
                }
                else if (change is mxGraphModel.mxGeometryChange)
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxGeometryChange)change).Cell, cells);
                }
                else if (change is mxGraphModel.mxCollapseChange)
                {
                    addTopmostVerticesAndEdges(((mxGraphModel.mxCollapseChange)change).Cell, cells);
                }
                else if (change is mxGraphModel.mxVisibleChange)
                {
                    ...
                    if (vc.Visible)
                    {
                        addTopmostVerticesAndEdges(((mxGraphModel.mxVisibleChange)change).Cell, cells);
                    }
                }
            }
        ...
        public virtual object[] getRemovedCellsForChanges(IList<mxUndoableEdit.mxUndoableChange> changes)
        {
            ...
            while (it.MoveNext())
            {
                ...
                else if (change is mxGraphModel.mxChildChange)
                {
                    ...
                    if (model.contains(cc.Previous) && !model.contains(cc.Parent))
                    {
        ...
        /// </summary>
        protected internal virtual IDictionary<string, object> postProcessCellStyle(IDictionary<string, object> style)
        {
            if (style != null)
            {
                ...
                if (!string.ReferenceEquals(image, null) && image.StartsWith("data:image/", StringComparison.Ordinal))
                {
        ...
        /// </summary>
        //public virtual void addImageBundle(mxImageBundle bundle)
        //{
        ...
        /// </summary>
        //public virtual void removeImageBundle(mxImageBundle bundle)
        //{
        ...
        /// </summary>
        public virtual string getImageFromBundles(string key)
        {
            //if (!string.ReferenceEquals(key, null))
            //{
            //    IEnumerator<mxImageBundle> it = imageBundles.GetEnumerator();
        ...
        /// </summary>
        //public virtual IList<mxImageBundle> ImageBundles
        //{
        //    get
        //    {
        //        return imageBundles;
        ...
        /// Returns the image bundles
        /// </summary>
        //public virtual void getImageBundles(IList<mxImageBundle> value)
        //{
        //    imageBundles = value;
        //}
                ...
                try
                {
                    for (int i = 0; i < cells.Length; i++)
                    {
                        ...
                        if (children != null && children.Length > 0)
                        {
                            ...
                            ((List<object>)result).AddRange((children));
                        }
                    }
        ...
        /// recursively using <model.cloneCells>. If the terminal of an edge
        ...
        /// <param name="height"> Integer that defines the height of the vertex. </param>
        /// <param name="style"> Optional string that defines the cell style. </param>
        /// <param name="relative"> Specifies if the geometry should be relative. </param>
        /// <returns> Returns the new vertex that has been inserted. </returns>
        public virtual object insertVertex(object parent, string id, object value, double x, double y, double width, double height, string style, bool relative)
        {
        ...
        /// <param name="relative"> Specifies if the geometry should be relative. </param>
        /// <returns> Returns the new vertex to be inserted. </returns>
        public virtual object createVertex(object parent, string id, object value, double x, double y, double width, double height, string style, bool relative)
        {
        ...
        /// mxEvent.CELLS_ADDED while the transaction is in progress.
        /// </summary>
        public virtual void cellsAdded(object[] cells, object parent, int? index, object source, object target, bool absolute, bool constrain)
        {
                ...
                try
                {
                    ...
                    for (int i = 0; i < cells.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            model.add(parent, cells[i], index.Value + i);
            ...
            if (cells != null && cells.Length > 0)
            {
                ...
                try
                {
                    for (int i = 0; i < cells.Length; i++)
                    {
                        ...
                        List<object> cellSet = new List<object>();
                        cellSet.Add((cells));
        ...
        /// <param name="checkFoldable"> Boolean indicating of isCellFoldable should be
        /// checked. Default is false. </param>
        public virtual object[] foldCells(bool collapse, bool recurse, object[] cells, bool checkFoldable)
        {
            if (cells == null)
            {
        ...
        /// <param name="checkFoldable"> Boolean indicating of isCellFoldable should be
        /// checked. Default is false. </param>
        public virtual void cellsFolded(object[] cells, bool collapse, bool recurse, bool checkFoldable)
        {
            if (cells != null && cells.Length > 0)
            {
                model.beginUpdate();
        ...
        public virtual object[] addAllEdges(object[] cells)
        {
            ...
            ((List<object>)allCells).AddRange((cells));
            ((List<object>)allCells).AddRange((getAllEdges(cells)));
        ...
        public virtual object[] getAllEdges(object[] cells)
        {
            ...
            if (cells != null)
            {
                for (int i = 0; i < cells.Length; i++)
                {
                    ...
                    // Recurses
                    object[] children = mxGraphModel.getChildren(model, cells[i]);
                    ((List<object>)edges).AddRange((getAllEdges(children)));
                }
            }
                ...
                try
                {
                    ...
                    if (size != null && geo != null)
                    {
                        ...
                        if (isSwimlane(cell))
                        {
                            ...
                            {
                                //cellStyle = mxStyleUtils.setStyle(cellStyle, mxConstants.STYLE_STARTSIZE, (size.Height + 8).ToString());
                            ...
                            {
                                //cellStyle = mxStyleUtils.setStyle(cellStyle, mxConstants.STYLE_STARTSIZE, (size.Width + 8).ToString());
        ...
        public virtual mxRectangle getPreferredSizeForCell(object cell)
        {
            ...
            if (cell != null)
            {
                ...
                if (style != null && !model.isEdge(cell))
                {
                    ...
                    if (!string.ReferenceEquals(getImage(state), null) || mxUtils.getString(style, mxConstants.STYLE_IMAGE) != null)
                    {
                    ...
                    for (int i = 0; i < cells.Length; i++)
                    {
                        ...
                        if (geo != null && (geo.X != tmp.X || geo.Y != tmp.Y || geo.Width != tmp.Width || geo.Height != tmp.Height))
                        {
                            ...
                            if (geo.Relative)
                            {
                                ...
                                if (offset != null)
                                {
                                    offset.X=(offset.X + tmp.X);
                                    offset.Y=(offset.Y + tmp.Y);
                                }
                            }
                            else
                            {
        ...
        public virtual object[] moveCells(object[] cells, double dx, double dy, bool clone)
        {
            ...
            return moveCells(cells, dx, dy, clone, 0, new Point());
        }
        ...
        public virtual object[] moveCells(object[] cells, double dx, double dy, bool clone, object target, Point location)
        {
            if (cells != null && (dx != 0 || dy != 0 || clone || target != null))
            {
                ...
                try
                {
                    ...
                    bool previous = AllowNegativeCoordinates;
                    ...
                    AllowNegativeCoordinates = previous;
        ...
        public virtual mxPoint getConnectionPoint(mxCellState vertex, mxConnectionConstraint constraint)
        {
            ...
            if (vertex != null && constraint.point != null)
            {
                ...
                mxPoint cx = new mxPoint(bounds.CenterX, bounds.CenterY);
                string direction = mxUtils.getString(vertex.Style, mxConstants.STYLE_DIRECTION);

                double r1 = 0;

                // Bounds need to be rotated by 90 degrees for further computation
                if (!string.ReferenceEquals(direction, null))
                {
                    ...
                    // Bounds need to be rotated by 90 degrees for further computation
                    if (string.ReferenceEquals(direction, mxConstants.DIRECTION_NORTH) || string.ReferenceEquals(direction, mxConstants.DIRECTION_SOUTH))
                    {
                        //bounds.rotate90();
                    }
                }
                ...
                double r2 = mxUtils.getDouble(vertex.Style, mxConstants.STYLE_ROTATION);
                ...
                else
                {
                    ...
                    if (this.Model.isVertex(vertex.cell))
                    {
                        bool flipH = mxUtils.getString(vertex.Style, mxConstants.STYLE_FLIPH).Equals(1);
                        bool flipV = mxUtils.getString(vertex.Style, mxConstants.STYLE_FLIPV).Equals(1);

                        if (flipH)
                        {
                            point.X = 2 * bounds.CenterX - point.X;
                        }

                        if (flipV)
                        {
                            point.Y = 2 * bounds.CenterY - point.Y;
                        }
                    }
                ...
                if (r2 != 0 && point != null)
                {
                    double rad = Common.ToRadians(2); //Math.toRadians(2);
        ...
        /// root and layer cells may be identified using model.isRoot and
        /// model.isLayer. This implementation returns null.
        /// </summary>
        ...
        public virtual mxRectangle getCellBounds(object cell, bool includeEdges, bool includeDescendants, bool boundingBox)
        {
            ...
            if (includeEdges)
            {
                ...
                List<object> edges = new List<object>((getEdges(cell)));

                //JAVA TO C# CONVERTER TODO TASK: There is no .NET equivalent to the java.util.Collection 'containsAll' method:
                while (edges.Count > 0 )
                {
                    allCells.AddRange(edges);
        ...
        /// implementation uses <model.isVisible>. Subclassers can override
        ...
        /// implementation uses <model.isCollapsed>. Subclassers can override
        ...
        /// implementation uses <model.isConnectable>. Subclassers can override
        ...
        {
            if (edge != null && !AllowDanglingEdges && (source == null || target == null))
            {
                return "";
            }
            ...
            if (source != null && target != null)
            {
                ...
                string err1 = validateEdge(edge, source, target);

                if (!string.ReferenceEquals(err1, null))
                {
                    error.Append(err1);
                }
        ...
        public virtual bool isCellEditable(object cell)
        {
            ...
            return CellsEditable && !isCellLocked(cell) && mxUtils.isTrue(style, mxConstants.STYLE_EDITABLE, true);
        }
        ...
        public virtual bool isCellResizable(object cell)
        {
            ...
            return CellsResizable && !isCellLocked(cell) && mxUtils.isTrue(style, mxConstants.STYLE_RESIZABLE, true);
        }
        ...
        public virtual bool isCellMovable(object cell)
        {
            ...
            return CellsMovable && !isCellLocked(cell) && mxUtils.isTrue(style, mxConstants.STYLE_MOVABLE, true);
        }
        ...
        /// </summary>
        /// <param name="cell"> Cell whose terminal point should be moved. </param>
        /// <param name="source"> Boolean indicating if the source or target terminal should be moved. </param>
        public virtual bool isTerminalPointMovable(object cell, bool source)
        {
            return true;
        }
        ...
        public virtual bool isCellBendable(object cell)
        {
            ...
            return CellsBendable && !isCellLocked(cell) && mxUtils.isTrue(style, mxConstants.STYLE_BENDABLE, true);
        }
        ...
        public virtual bool isCellDeletable(object cell)
        {
            ...
            return CellsDeletable && mxUtils.isTrue(style, mxConstants.STYLE_DELETABLE, true);
        }
        ...
        public virtual bool isCellCloneable(object cell)
        {
            ...
            return CellsCloneable && mxUtils.isTrue(style, mxConstants.STYLE_CLONEABLE, true);
        }
        ...
        public virtual bool isAutoSizeCell(object cell)
        {
            ...
            return AutoSizeCells || mxUtils.isTrue(style, mxConstants.STYLE_AUTOSIZE, false);
        }
        ...
        {
            return ConstrainChildren && !Model.isEdge(Model.getParent(cell));
        }
        ...
        /// </summary>
        /// <returns> Returns the enabled state of the ports. </returns>
        public virtual bool PortsEnabled
        {
            get
            {
                return portsEnabled;
        ...
        /// to be returned. </param>
        /// <returns> Returns the connected edges for the given cell. </returns>
        public virtual object[] getConnections(object cell, object parent, bool recurse)
        {
        ...
        /// </summary>
        /// <param name="cell"> Cell whose edges should be returned. </param>
        /// <param name="parent"> Optional parent. If specified the opposite end of any edge
        /// must be a direct child of that parent in order for the edge to be returned. </param>
        ...
        /// or the parent just be an ancestral parent. </param>
        /// <param name="incoming"> Specifies if incoming edges should be included in the
        /// result. </param>
        /// <param name="outgoing"> Specifies if outgoing edges should be included in the
        /// result. </param>
        /// <param name="includeLoops"> Specifies if loops should be included in the result. </param>
        /// <param name="recurse"> Specifies if the parent specified only need be an ancestral
        /// parent, <code>true</code>, or the direct parent, <code>false</code> </param>
        /// <returns> Returns the edges connected to the given cell. </returns>
        public virtual object[] getEdges(object cell, object parent, bool incoming, bool outgoing, bool includeLoops, bool recurse)
        {
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                {
                    ((List<object>)edges).AddRange((mxGraphModel.getEdges(model, child, incoming, outgoing, includeLoops)));
                }
            }

            ((List<object>)edges).AddRange((mxGraphModel.getEdges(model, cell, incoming, outgoing, includeLoops)));
        ...
        /// based on whether ancestor recursion is enabled. </summary>
        /// <param name="cell"> the possible child cell </param>
        /// <param name="parent"> the possible parent cell </param>
        /// <param name="recurse"> whether or not to recurse the child ancestors </param>
        /// <returns> whether or not the specified parent is a valid
        /// ancestor of the specified cell, either direct or indirectly
        /// based on whether ancestor recursion is enabled. </returns>
        public virtual bool isValidAncestor(object cell, object parent, bool recurse)
        {
        ...
        /// result. </param>
        /// <param name="targets"> Specifies if target terminals should be included in the
        /// result. </param>
        /// <returns> Returns the cells at the opposite ends of the given edges. </returns>
        ...
        /// 
        /// <param name="cells"> </param>
        public virtual void setSelectionCells(List<object> cells)
        {
            if (cells != null)
            {
        ...
        public virtual void selectCells(bool vertices, bool edges, object parent)
        {
            ...
            object[] temp = new object[cells.Count];
            cells.CopyTo(temp,0);
            setSelectionCells(temp);
        }
        ...
        {
            drawState(canvas, View.getState(cell), true);
        ...
        /// <param name="drawLabel"> Indicates if the label should be drawn. </param>
        public virtual void drawState(mxICanvas canvas, mxCellState state, bool drawLabel)
        {
            //object cell = (state != null) ? state.Cell : null;

            //if (cell != null && cell != view.CurrentRoot && cell != model.Root && (model.isVertex(cell) || model.isEdge(cell)))
            //{
            ...
            //    // be clipped
            //    Shape clip = null;
            //    Rectangle newClip = state.Rectangle;

            //    // Indirection for image canvas that contains a graphics canvas
            //    mxICanvas clippedCanvas = (isLabelClipped(state.Cell)) ? canvas : null;

            //    if (clippedCanvas is mxImageCanvas)
            //    {
            //        clippedCanvas = ((mxImageCanvas)clippedCanvas).GraphicsCanvas;
            //        // TODO: Shift newClip to match the image offset
            //        //Point pt = ((mxImageCanvas) canvas).getTranslate();
            //        //newClip.translate(-pt.x, -pt.y);
            //    }

            //    if (clippedCanvas is mxGraphics2DCanvas)
            //    {
            //        Graphics g = ((mxGraphics2DCanvas)clippedCanvas).Graphics;
            //        clip = g.Clip;

            //        // Ensure that our new clip resides within our old clip
            //        if (clip is Rectangle)
            //        {
            //            g.Clip = newClip.intersection((Rectangle)clip);
            //        }
            ...
            //        if (!string.ReferenceEquals(label, null) && state.LabelBounds != null)
            //        {
            ...
            //    if (clippedCanvas is mxGraphics2DCanvas)
            //    {
            //        ((mxGraphics2DCanvas)clippedCanvas).Graphics.Clip = clip;
            //    }
        ...
        protected internal virtual void cellDrawn(mxICanvas canvas, mxCellState state, object element, object labelElement)
        {
            if (element is Element)
            {
                ...
                if (!string.ReferenceEquals(link, null))
                {
                    ...
                    else if (elem.OwnerDocument.GetElementsByTagName("svg").Count > 0)
                    {
